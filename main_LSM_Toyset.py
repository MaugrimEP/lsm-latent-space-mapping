...
from datasets.transforms import toyset_transforms_source, toyset_transforms_target
...
from params.Toyset.model_params_toyset_lsm import cfg
from params.slurm_params import cfg_slurm
from params.Toyset.params_toyset_128 import cfg_dataset
...
def main(params: dict):
	...
	data: SOP_data = get_dataloader_SOP(
		...
		shuffle_mode=True,
		transforms_source=toyset_transforms_source,
		transforms_target=toyset_transforms_target,
