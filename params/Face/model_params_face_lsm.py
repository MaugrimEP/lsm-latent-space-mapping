...
class cfg_class:
	...
	native_discriminator_latent_layer_out: List[int] = return_factory([1024, 256, 128, 64, 1])
	...
	netD_domain: str = 'n_layers'        # [basic [ n_layers | pixel]
	n_layers_D_domain: int = 3           # only used if netD==n_layers
	netD_latent: str = 'n_layers'        # [basic [ n_layers | pixel]
	n_layers_D_latent: int = 2           # only used if netD==n_layers
