...
class cfg_class:
	...
	# region model
	use_native_archi: bool = True     # use the same architecture as IODA & SOP
	...
	epochs_output: int = 1000
	epochs_full  : int = 1000
